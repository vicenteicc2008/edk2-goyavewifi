...
{0x87A40000, 0x00020000, "HLOS 3",           AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
...
{0xf5208000, 0x00001000, "Keypad",          	AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
{0xF5220000, 0x00001000, "GPIO",  		 	    AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
{0xF5224000, 0x00001000, "PinCtrl",          	AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
{0xF5112000, 0x00004000, "DMA",  		 	    AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
{0xF511C000, 0x00001000, "SDHCI 0",  		 	AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
{0xF5117000, 0x00001000, "SDHCI 1",  		 	AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
{0xF5118000, 0x00001000, "SDHCI 2",  		 	AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
