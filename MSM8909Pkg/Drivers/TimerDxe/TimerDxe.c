/** @file
  ...
  Copyright (c) 2015, Spreadtrum Communications Inc. All rights reserved.<BR>
...
#include <Library/SprdTimerLib.h>
  ...
  )
{
  ...
  if (TimerPeriod == 0) {
	...
	MmioWrite32 ((TimerBase + PWM_TCNTB0_OFFSET), TimerTicks);
...
*/
  ...
  // Timer 0 used by Period counter with Auto re-load mode
  MmioWrite32 ((TimerBase + PWM_TCNTB0_OFFSET), FixedPcdGet32(PcdTimerPeriod));
